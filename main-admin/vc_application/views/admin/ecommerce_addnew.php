	...
	<!--	<div class="form-group col-sm-12">
        ...
        <label  class="control-label col-sm-3">Stock keeping unit(SKU) <small style="color:red">*</small></label>
         ...
         <label  class="control-label col-sm-3">HSN</label>
             <div class="col-sm-9">  <input type="text" class="form-control"  name="hsn" value="<?php if($this->input->post('hsn')!='') { echo $this->input->post('hsn'); }   ?>" >
          </div>
          </div>

          <div class="form-group col-sm-12">
         <label  class="control-label col-sm-3">Dimensions</label>
             <div class="col-sm-9">  <input type="text" class="form-control"  name="dimensions" value="<?php if($this->input->post('dimensions')!='') { echo $this->input->post('dimensions'); }   ?>" >
          </div>
          </div>

          <div class="form-group col-sm-12">
         <label  class="control-label col-sm-3">Counrty of Origin</label>
             <div class="col-sm-9">  <input type="text" class="form-control"  name="origin" value="<?php if($this->input->post('origin')!='') { echo $this->input->post('origin'); }   ?>" >
          </div>
          </div>
		  <div class="form-group col-sm-12">
          ...
          <div class="form-group col-sm-12">
           <label  class="control-label col-sm-3">Gold Package</label>
		  ...
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
		   ...
		   <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">Count</label>
             <div class="col-sm-7"> <input type="number" class="form-control"  name="roi_count" value="<?php if($this->input->post('roi_count')!='') { echo $this->input->post('roi_count'); }   ?>" >
          </div> 
          </div> 
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">Amount</label>
             <div class="col-sm-7"> <input type="number" step="0.01" class="form-control"  name="roi_amount" value="<?php if($this->input->post('roi_amount')!='') { echo $this->input->post('roi_amount'); }  ?>" >
          </div> 
          </div>
        </div>
        </div>
	...
	<div class="panel panel-default">
        ...
        <div class="panel-body">
		 ...
		 <p> <br><button class="btn btn-success btn-sm add-attribute1" type="button">Add Attribute</button> </p>
		    <div class="col-sm-12"><label>Color</label></div>  
      ...
      var add_attr = '<div class="remove-div-'+uid+'"><div class="form-group col-sm-11"><input placeholder="Color" type="text" required class="form-control" name="colors[]" value="" ></div><div class="col-sm-1"><button data=".remove-div-'+uid+'" type="button" class="remove-btn glyphicon glyphicon-remove remove-div"></button></div></div>';
