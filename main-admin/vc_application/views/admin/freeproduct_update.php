	 ...
	 //form data
      ...
      ?>
		...
		<div class="form-group col-sm-12">
          ...
          <label  class="control-label col-sm-3">Brand <small style="color:red">*</small></label>

             <div class="col-sm-9"> <input type="text" class="form-control" required name="s_name" value="<?php if($this->input->post('s_name')!='') { echo $this->input->post('s_name'); } else { echo $prod['s_name']; }  ?>" >
  ...
  <div class="form-group col-sm-12">
		...
		<input type="hidden" value="<?php echo $prod['image'];?>" name="image_old">
		 ...
		 <p> <br><button class="btn btn-success btn-sm add-attribute" type="button">Add Attribute</button> </p>
		    <div class="col-sm-5"><label>Value</label></div><div class="col-sm-5"><label>Coins</label></div>  
