...
<thead> <tr> <th>Sr no</th><th>OrderID.</th><th>Name</th><th>customer id</th><th>Phone</th><th>Amount</th><th>Bv</th><th>Status</th><th>Date</th> </tr> </thead> 
<tbody> 
<?php 
$i = 1;
$total_amount=0;
...
$total_amount = $total_amount + $con['total_amount']; 
	...
	echo '<tr class='.$con['status'].'><td>'.$i.'</td><td>'.$con['id'].'</td>
...
?>
</tbody><tr style="height:40px;background-color:#0098da;"> 	<td colspan="4"><center><b>Total</b></center></td><td></td>	<td>Rs <?php echo $total_amount; ?></td>	<td>Bv <?php echo $comm_dis; ?></td>	<td></td><td></td>	</tr>
