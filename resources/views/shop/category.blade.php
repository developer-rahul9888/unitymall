                        ...
                        <div class="product-box product-wrap" data-id="{{ $product->id }}">
                            ...
                            <div class="product-detail text-center">
                                ...
                                <div class="cost-detail">
                                    <h4>₹{{ $product->cost }} @if($product->price > $product->cost)<del>₹{{ $product->price }}</del>@endif</h4>
                                                    ...
                                                    <div class="col-xl-6 col-md-6 col-sm-12">
                                                        <nav aria-label="Page navigation">
                                                            <ul class="pagination">
                                                                ...
                                                                @if($page > 1) 
                                                                    <li class="page-item"><a class="page-link" href="{{ url('category/'.Request::segment(2).'?page='.($currentPage-1)) }}"
                                                                ...
                                                                <li class="page-item active"><a class="page-link"
                                                                        href="{{ url('category/'.Request::segment(2).'?page='.$number) }}">{{ $number; }}</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="error-section">
                        <h2>Not Found</h2>
                        <a href="{{url('')}}" class="btn btn-solid">back to shop</a>
                    </div>
                </div>
            </div>
        </div>
