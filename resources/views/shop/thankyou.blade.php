            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="success-text">
                        ...
                        <p class="font-weight-bold">Transaction ID:{{ $order->transaction_id }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="product-order">
                        ...
                        <div class="row product-order-detail">
                            <div class="col-3">
                                <img src="{{ asset('../main-admin/images/product/'.$item->product->image) }}" alt="" class="img-fluid blur-up lazyload"></div>
                        ...
                        <div class="total-sec">
                            <ul>
                                <li>subtotal <span>₹ {{ $order->total_amount - $order->tax }}</span></li>
                                <li>shipping <span>₹ {{ $order->shipping }}</span></li>
                                <li>tax(GST) <span>₹ {{ $order->tax }}</span></li>
                            </ul>
                        </div>
                        <div class="final-total">
                            <h3>total <span>₹ {{ $order->total_amount }}</span></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    ...
                                    <li>Order Date: {{ $order->o_date->format('F j, Y') }}</li>
                            ...
                            <div class="col-sm-6">
                                ...
                                <ul class="order-detail">
                                    <li>{{ $order->p_name }}</li>
                                    <li>{{ $order->p_address }}</li>
                                    <li>{{ $order->p_city }} {{ $order->p_state }}, {{ $order->p_zip }}</li>
                                    <li>Contact No. {{ $order->p_phone }}</li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="delivery-sec">
                                    <h3>expected date of delivery: <span>{{ date('F j, Y',strtotime('+5 days',strtotime($order->o_date))) }}</span></h3>
