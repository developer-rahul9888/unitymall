                    ...
                    <div class="col-sm-3 collection-filter">
                        ...
                        <div class="collection-filter-block">
                            <div class="product-service">
                                <div class="media">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#returnable"></use>
                                    </svg>
                                ...
                                <div class="media">
                                    <svg>
                                        <use xlink:href="https://themes.pixelstrap.com/multikart/assets/svg/icons.svg#warranty"></use>
                                    </svg>
                                    <div class="media-body">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="product-slick">
                                            <div>
                                                <img src="{{ asset('../main-admin/images/product/'.$product->image) }}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-0">
                                            </div>
                                            @foreach(json_decode($product->images) as $key=>$image)
                                            <div>
                                                <img src="{{ asset('../main-admin/images/product/'.$image) }}" alt="" class="img-fluid blur-up lazyload image_zoom_cls-{{$key+1}}">
                                            </div>
                                            @endforeach
                                    </div>
                                    <div class="row">
                                        <div class="col-12 p-0">
                                            <div class="slider-nav">
                                                <div>
                                                    <img src="{{ asset('../main-admin/images/product/'.$product->image) }}" alt="" class="img-fluid blur-up lazyload">
                                                </div>

                                                @foreach(json_decode($product->images) as $image)
                                                <div>
                                                    <img src="{{ asset('../main-admin/images/product/'.$image) }}" alt="" class="img-fluid blur-up lazyload">
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-6 rtl-text">
                                    <div class="product-right product-box" data-id="{{ $product->id }}">
                                        <h2>{{ $product->pname }}</h2>
                                        <h4 style="margin-bottom: 15px;color: green;font-weight: 600;">COINS {{ $product->comm_dis }}</h4>
                                        <h3 class="price-detail">₹{{ $product->p_d_price }} @if($product->cost > $product->p_d_price)<del>₹{{ $product->cost }}</del>@endif
                                            @if($percent)
                                        ...
                                        <div id="selectSize"
                                            ...
                                            <div class="qty-box">
                                                <div class="input-group"><span class="input-group-prepend">
                                                    <button type="button" class="btn quantity-left-minus" data-type="minus" data-field="quantity">
                                                        <i class="ti-angle-left"></i></button> </span>
                                                    <input type="text" name="quantity" class="form-control input-number qty-input" value="{{ $qty }}"> 
                                                    <span class="input-group-prepend">
                                                        <button type="button" class="btn quantity-right-plus" data-type="plus" data-field="quantity">
                                                            <i class="ti-angle-right"></i></button></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="product-buttons"><button href="{{ route('add.to.cart', $product->id) }}" id="cartEffect"
                                                class="btn btn-solid hover-solid btn-animation add-button"><i
                                                    class="fa fa-shopping-cart me-1" aria-hidden="true"></i> add to
                                                cart</button></div>
                                        <div class="product-count">
                                            <ul>
                                                <li>
                                                    <img src="{{asset('assets/images/icon/truck.png')}}" class="img-fluid"
                                                        alt="image">
