...
@if($popup)
<!-- Modal -->
<div class="modal fade show" id="homeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
    <img src="https://www.unitymall.club/main-admin/images/popup/{{$popup->image}}" class="img-responsive">
...
@endif
    ...
    <section class="p-0">
        ...
        <div>
            <div class="home">
            <img src="{{ url('../main-admin/images/product/'.$slider->image) }}" alt="" class="bg-img blur-up lazyload">
                <!-- <div class="container">
                    <div class="row">
                        <div class="col">
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/vegetables/banner/17.jpg"
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/vegetables/banner/19.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                ...
                <div class="col-lg-4">
                    <a href="#">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="../assets/images/vegetables/banner/18.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner white-content banner-3">
                                <div>
    ...
    <section class="section-b-space addtocart_count ratio_square">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="title4">
                        <a href="{{url('/product')}}" class="btn btn-outline-danger view-all">View All</a>
                        <h2 class="title-inner4">Featured Products</h2>
                                ...
                                @foreach ($products as $product)
                                            @php $percent = ''; $class = ''; $qty = 0; $cart = session()->get('cart', []); 
                                                if($product->p_d_price < $product->cost) {
                                                    $diff = ($product->cost - $product->p_d_price)*100;
                                                    $percent = floor($diff/$product->cost);
                                                }
                        ...
                        <div class="product-box product-wrap" data-id="{{ $product->id }}">
                            ...
                            <div class="product-detail text-center">
                                ...
                                <div class="cost-detail">
                                    <h4>₹{{ $product->p_d_price }} @if($product->cost > $product->p_d_price)<del>₹{{ $product->cost }}</del>@endif</h4>
                                    <h4>Coin {{ $product->comm_dis }}</h4>
                                </div>
                            </div>
                        </div>
                                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="title4">
                    <a href="{{url('/product')}}" class="btn btn-outline-danger view-all">View All</a>
                        <h2 class="title-inner4">Latest Products</h2>
                        <div class="line"><span></span></div>
                    </div>
                    <div class="product-5 product-m no-arrow">
                ...
                <div class="row partition2">
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="../assets/images/vegetables/banner/22.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="../assets/images/vegetables/banner/23.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="#">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="../assets/images/vegetables/banner/24.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                            </div>
                        </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="title4">
                            <a href="{{url('/product')}}" class="btn btn-outline-danger view-all">View All</a>
                            <h2 class="title-inner4">Lowest Products</h2>
                            <div class="line"><span></span></div>
                        </div>
                        <div class="product-5 product-m no-arrow">
    ...
    <!-- product section end -->
      ...
      <!-- category start -->
      <section class="section-b-space addtocart_count ratio_square category-style-1">
      <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <div class="title4">
                        <a href="{{url('/product')}}" class="btn btn-outline-danger view-all">View All</a>
                        <h2 class="title-inner4">Online Stores</h2>
                        <div class="line"><span></span></div>
                    </div>
                ...
                <div class="col-12">
                    <div class="slide-7-demo slick-sm-margin no-arrow">
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/11.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/12.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/13.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/14.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/15.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/16.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/17.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/18.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                ...
                <div class="col-12">
                    <div class="slide-7-demo slick-sm-margin no-arrow">
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/19.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/20.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/21.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
                        ...
                        <div class="product-box product-style-4">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page.html"><img alt="" src="../assets/images/vegetables/pro/22.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                            class="ti-heart" aria-hidden="true"></i></a> <a href="#"
...
$("button.add-button").click(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response.status) {
                    $(ele).next().addClass("open");
                    $(".qty-input").val('1');
                    triggerNotification('success',response.message);
                    checkcartvalue();
                } else {
                    triggerNotification('danger',response.message);
                }
            }
        });
