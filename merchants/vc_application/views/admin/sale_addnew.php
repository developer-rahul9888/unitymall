...
form .row{margin-left:-5px;margin-right:-5px;}
      ...
      <div class="page-heading"><a class="btn btn-primary flr" href="<?php echo base_url().'admin/sale'; ?>">Back</a>
        <h2>Add new sale</h2>
		<a href="<?php echo base_url().'admin/salel/add'; ?>" class="btn btn-primary btn-sm"  >Misslaneous Product </a>
      </div>
						   ...
						   <input type="hidden" value="<?php echo implode(',',$selecte_pid);?>" name="pid_array">
							...
							<hr>
								...
								<div class="row print-hide">
									...
									<input id="show_invoice"  style="display:none" type="submit" name="buttonSubmits" value="Generate Invoice" class="btn btn-success print-hide" /> 
